                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('menu.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control form-control" type="text" id="nama_menu" name="nama_menu"
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control form-control" type="text" id="harga" name="harga"
                                    placeholder="Harga...">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label class="form-label mb-1" for="waktu_pembuatan">Estimasi Waktu Pembuatan</label>
                                <div class="row">
                                    <div class="">
                                        <input class="form-control form-control" type="time" id="waktu_pembuatan"
                                            name="waktu_pembuatan" placeholder="Estimasi pembuatan...">
                                    </div>
                                </div>
                            </div>
                            <div class="mb-3">
                                ...
                                <img class="mt-3 rounded-2" id="gambar-preview" src="#" alt="Preview Gambar"
                                    style="max-width: 250px; max-height: 150px; display: none;">
                                <script>
